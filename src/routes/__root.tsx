...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "Kobo Book Buddy manages your EPUB library, optimizing and uploading books to your Kobo device." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "Kobo Book Buddy manages your EPUB library, optimizing and uploading books to your Kobo device." },
